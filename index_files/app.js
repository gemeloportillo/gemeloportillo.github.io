...
// Google Analytics
 ...
 // ga('create', 'UA-42183166-2', 'arteyciencia.mx');
 // ga('send', 'pageview');
...
function OnMapsInitialized() {
    ...
    pos_lat_narvarte = new google.maps.LatLng(19.4015313, -99.1461197);

    var mapOptions = { mapTypeControlOptions: { mapTypeIds: ['Styled'] }, zoom: 16, center: pos_lat_narvarte, mapTypeId: 'Styled', scrollwheel: false };

    map = new google.maps.Map(document.getElementById('map-canvas'), mapOptions);
    var styledMapType = new google.maps.StyledMapType(MapStyles, { name: 'Styled' });

    map.mapTypes.set('Styled', styledMapType);
    var marker_narvarte = new google.maps.Marker({ position: pos_lat_narvarte, title: "ArteyCiencia Miguel Angel Portillo Bobadilla", icon: "images/icons/location-marker.png", visible: true }).setMap(map);
...
$(document).ready(function () {
    ...
    function InitVideo() {
        ...
        $('<img/>').attr('src', '/cv/imgs/intro.jpg').load(function () {
